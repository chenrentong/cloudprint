...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 云设备管理 <span class="c-gray en">&gt;</span> 项目管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<div id="tab-system" class="HuiTab">
			<div><a id="a" href="javascript:;" onclick="classify_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>新增项目 </a></div>
			<div class="tabBar cl" style="margin-top: 10px">
				<span>微信</span>
				<span>饿了么</span>
			</div>
			<div class="tabCon">
