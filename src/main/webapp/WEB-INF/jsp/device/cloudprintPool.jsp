...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 云设备管理 <span class="c-gray en">&gt;</span> 编号池管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
   ...
   <span class="l">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c">
            ...
            <td>${vo.number }</td>
            <td>${vo.remark }</td>
            <td><fmt:formatDate type="both"  pattern="yyyy-MM-dd HH:mm:ss" value="${vo.upload_date }" /></td>
            <td> 
